				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td><c:if test="${contributor.username !=null }">
											<c:out value="${contributor.username}" />
											<input type="hidden" value="${contributor.username}" name="contributor"/>
										</c:if></td>
							<td><c:if test="${link.lid !=null }">
											<c:out value="${link.lid}" />
											<input type="hidden" value="${link.lid}" name="lid"/>
										</c:if></td>
							<td><c:if test="${link.url !=null }">
											<c:out value="${link.url}" />
											<input type="hidden" value="${link.url}" name="url"/>
										</c:if></td>
							<td><c:if test="${contributor.adUrl !=null }">
											<c:out value="${contributor.adUrl}" />
											<input type="hidden" value="${contributor.adUrl}" name="adUrl"/>
										</c:if></td>
